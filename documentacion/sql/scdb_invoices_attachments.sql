...
CREATE TABLE `invoices_attachments` (
  ...
  PRIMARY KEY (`id`),
  KEY `invoices_attachments_invoice_id_foreign` (`invoice_id`),
  CONSTRAINT `invoices_attachments_invoice_id_foreign` FOREIGN KEY (`invoice_id`) REFERENCES `invoices` (`id`) ON DELETE CASCADE
...
LOCK TABLES `invoices_attachments` WRITE;
/*!40000 ALTER TABLE `invoices_attachments` DISABLE KEYS */;
/*!40000 ALTER TABLE `invoices_attachments` ENABLE KEYS */;
UNLOCK TABLES;
