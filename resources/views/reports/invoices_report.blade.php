    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <form action="/search-invoices" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
                    <div class="col-lg-3">
                        <label class="rdiobox">
                            <input checked name="rdio" type="radio" value="1" id="search_by_type">
                            <span>Buscar por tipo de factura</span>
                        </label>
                    </div>
                    ...
                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                        <label class="rdiobox">
                            ...
                            <span>Buscar por número de factura</span>
                        </label>
                    </div><br><br>

                    <div class="row">
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">Selecciona el tipo de factura</p>

                            <select class="form-control select2" name="type" required>
                                <option value="{{ $type ?? 'Selecciona el tipo de facturas' }}" selected>
                                    {{ $type ?? 'Selecciona el tipo de facturas' }}
                                </option>
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="invoice_number">
                            <p class="mg-b-10">Buscar por número de factura</p>
...
<script>
    /**
     * Se cambian los inputs de búsqueda dependiendo si queremos buscar por tipo o por número de factura
     */
    $(document).ready(function() {
        // por defecto oculto el input para buscar por número de factura
        $('#invoice_number').hide();

        $('input[type="radio"]').click(function() {
            if ($(this).attr('id') == 'search_by_type') {
                $('#invoice_number').hide();
                $('#type').show();
                $('#start_at').show();
                $('#end_at').show();
