                    ...
                    <table class="table table-hover" id="example1" data-page-length='50' style=" text-align: center;">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">Nombre de usuario</th>
                                <th class="wd-20p border-bottom-0">Correo electrónico</th>
                                <th class="wd-15p border-bottom-0">Estado de usuario</th>
                                <th class="wd-15p border-bottom-0">Tipo de usuario</th>
                                <th class="wd-10p border-bottom-0">Procesos</th>
                            </tr>
                        </thead>
                        <tbody>
