...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Usuarios</h4>
            <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Agregar usuario</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
            ...
            <div class="card-body">
                ...
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                    ...
                    <div class="">
                        ...
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-6" id="fnWrapper">
                                <label>Nombre de usuario: <span class="tx-danger">*</span></label>
                    ...
                    <div class="row mg-b-20">
                        ...
                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                            <label>Confirmar contraseña: <span class="tx-danger">*</span></label>
                            <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                        <button class="btn btn-main-primary pd-x-20" type="submit">Confirmar</button>
                    </div>
                </form>
            </div>
        </div>
